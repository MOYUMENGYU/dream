...
import mis.managerframe.LookupDialogCourse;
import mis.managerframe.LookupResultCourse;
import mis.tool.SqlOperation;

public class TeacherPersonCourse implements Layout{
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(rowSelect>=0) {
					...
					if(order==JOptionPane.OK_OPTION) {
						...
						System.out.println(table.getModel().getValueAt(rowSelect,0));
