...
public class StudentAdd implements Layout{
	CardLayout card=new CardLayout();
	JPanel pane=new JPanel(card);
	JTable table=new JTable();
	public JPanel studentAdd() {
		...
		JTextField collage_text=new JTextField(20);
		...
		JLabel classNumber_label=new JLabel("地     址:");
		JTextField classNumber_text=new JTextField(20);
		...
		keep_button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				student.setSex((String)combo.getSelectedItem());
				...
				if(SqlOperation.saveStudent(student)>=0) {
